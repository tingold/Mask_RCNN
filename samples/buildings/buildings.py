...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 buildings.py train --dataset=/path/to/coco/ --model=coco

    # Train a new model starting from ImageNet weights. Also auto download COCO dataset
    python3 buildings.py train --dataset=/path/to/coco/ --model=imagenet --download=True

    # Continue training a model that you had trained earlier
    python3 buildings.py train --dataset=/path/to/coco/ --model=/path/to/weights.h5

    # Continue training the last model you trained
    python3 buildings.py train --dataset=/path/to/coco/ --model=last

    # Run COCO evaluatoin on the last model you trained
    python3 buildings.py evaluate --dataset=/path/to/coco/ --model=last
"""
...
class BuildingDataset(utils.Dataset):
    ...
    def load_mask(self, image_id):
        ...
        mask = '/Users/tingold/code/Mak_RCNN/samples/buildings/training_data'+'/osm/osm_'+image_id
